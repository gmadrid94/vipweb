...
**Recomendación:** Mantener WAMP local con backups/evidencias y exigir Git local mínimo verificable cuando el trigger de cambios protegidos preparados por IA aplique.

## Contexto

VipWeb mantiene como flujo vigente Sprint 0/Core Runtime local en Windows/WAMP, sin repositorio remoto, staging real ni despliegue externo. Desde ADR-030, el repo local `C:/wamp64/www/vipweb` debe estar bajo Git para el modelo AI-first; esta ADR sigue definiendo el activation_record necesario para cambios protegidos preparados por IA.
