...
Ningún documento crítico puede ser marcado como `VALIDATED` sin evidencia asociada en `evidence/` bajo `PROJECT_CONTROL_ROOT` y sin pasar Doctor estructural, de consistencia y semántico.
