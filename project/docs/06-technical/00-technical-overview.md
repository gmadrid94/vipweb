...
Baseline `1.2` separa `APP_ROOT = C:/wamp64/www/vipweb`, `PROJECT_CONTROL_ROOT = C:/wamp64/www/vipweb/project`, `BACKUP_ROOT = C:/wamp64/www/vipweb_backups` y `EXTERNAL_ROADMAP_TOOLS_ROOT = C:/wamp64/www/vipweb_tools`. Las rutas documentales `docs/`, `machine/`, `database/`, `scripts/`, `templates/` y `evidence/` son relativas a `PROJECT_CONTROL_ROOT`.
