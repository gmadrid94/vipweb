...
## Ejecución mediante tools externas

Sprint 0 debe ejecutarse con tools externas cuando una tarea requiera acceso local real. Las salidas deben escribirse en `C:/wamp64/www/vipweb_tools/logs` y revisarse con GPT antes de continuar.

La Fase 1 debe confirmar:

- WAMP sirve `C:/wamp64/www/vipweb/public` como document root público;
- carpetas privadas no son accesibles por navegador;
- `C:/wamp64/www/vipweb` está bajo Git;
- `C:/wamp64/www/vipweb_backups` existe para backups externos;
- `C:/wamp64/www/vipweb_tools/logs` conserva logs por ejecución.
