...
| `ADR026_GIT_CONDITIONAL_LANGUAGE_DECLARED` | documentation | high | La auditoría ADR matiza WAMP/no Git con trigger condicional ADR-026. |
| `ADR_026_NOT_COUNTED_AS_ACCEPTED` | semantic | high | ADR-026 no cuenta como aceptada y no altera el conjunto vigente de 27 ADRs aceptadas. |
| `ADR_026_REGISTERED_AS_PROPOSED_CONDITIONAL` | semantic | high | ADR-026 existe como propuesta condicional machine-readable. |
| `ADR_ACCEPTED_COUNT_AND_PROPOSED_ADR026_ALIGNED` | consistency | high | Las 27 ADRs aceptadas están sincronizadas entre carpeta ADR, decision log y machine/decisions.json; ADR-026 permanece propuesta condicional. |
...
| `UPDATE_SCRIPT_BASELINE_IS_CANONICAL` | documentation | low | El validador documental actual declara documentation_baseline 1.0 como baseline canónica. |
...
| `LOCAL_EXECUTION_RECORD_EXISTS` | structure | high | registro de ejecución local y plantilla de entrada local existen para operar sin Git obligatorio base. |
...
| `CANONICAL_ROOT_IDENTITY_MATCHES_FOLDER` | documentation | high | La carpeta raíz, README y CURRENT_STATUS declaran identidad VipWeb y documentation_baseline 1.0. |
...
| `CANONICAL_BASELINE_NOT_OVERRIDDEN_BY_AUXILIARY_NOTES` | documentation | medium | Las notas auxiliares no prevalecen sobre documentation_baseline 1.0 ni sobre CURRENT_STATUS.md como estado canónico. |
...
| `README_STATUS_MATCHES_CURRENT_STATUS` | documentation | high | README.md y CURRENT_STATUS.md declaran documentation_baseline 1.0, estado READY_FOR_SPRINT_0 y bloqueo del desarrollo visible hasta Sprint 0 local real. |
| `README_BASELINE_MATCHES_CURRENT_STATUS` | documentation | low | README.md y CURRENT_STATUS.md declaran documentation_baseline 1.0 y estado READY_FOR_SPRINT_0 con lenguaje canónico. |
