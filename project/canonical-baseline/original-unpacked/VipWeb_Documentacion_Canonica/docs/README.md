...
`scripts/update_script.py` es el validador documental ejecutable actual. Comprueba estructura, JSON, schemas machine-readable, checksums SQL, identidad canónica, estado operativo y referencias internas.
