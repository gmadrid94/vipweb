...
**Fuente canónica:** `machine/journeys.json, machine/ui_screens.json y machine/screen_component_contracts.json`  
**Schema asociado:** `machine/schemas/journey.schema.json`  
