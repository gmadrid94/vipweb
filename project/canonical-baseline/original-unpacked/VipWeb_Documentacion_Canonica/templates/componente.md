...
**Fuente canónica:** `machine/screen_component_contracts.json y machine/design_tokens.json`  
**Schema asociado:** `machine/schemas/screen-component-contract.schema.json`  
