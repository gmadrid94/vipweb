...
**Fuente canónica:** `machine/ui_screens.json, machine/screen_component_contracts.json, machine/ui_state_copy.json y machine/screen_responsive_behavior.json`  
**Schema asociado:** `machine/schemas/ui-screen.schema.json y machine/schemas/screen-component-contract.schema.json`  
